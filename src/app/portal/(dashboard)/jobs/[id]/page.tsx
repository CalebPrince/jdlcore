            ...
            {coq[0] && (
              ...
              >
                <div className="min-w-0 flex-1">
                  <p className="m-0 truncate text-sm font-semibold text-navy-950">Certificate of Quantity</p>
                ...
                >
                  ...
                  <span
                    className={`rounded-full px-3 py-0.5 text-xs font-bold ${
                      (INVOICE_STATUS_META[invStatus] ?? INVOICE_STATUS_META.pending).badgeClass
                    }`}
                  >
                  ...
                  {invStatus === "payment_rejected" && inv.paymentRejectedReason && (
                    <p className="m-0 w-full rounded-md bg-red-50 p-3 text-sm text-red-800">
