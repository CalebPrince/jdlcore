...
async function buildCoqPdf(
  ...
  // this job, these are the outturn quantities summed across every tank (the amount moved), not a
  // single tank reading; the full per-tank breakdown is on the separate Outturn Report.
  y -= 44;
